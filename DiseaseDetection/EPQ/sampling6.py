...
sample_path  = os.path.join("dataset/", plantname)
sampling_train_results = os.path.join("output/", plantname, (plantname + "_train_samples6.h5"))
sampling_test_results = os.path.join("output/", plantname, (plantname + "_test_samples6.h5"))

#sample_path = "dataset/Corn"
#sampling_train_results = "output/corn/Corn_train_samples6.h5"
#sampling_test_results = "output/corn/Corn_test_samples6.h5"
#------------------------------------------------------
